      ...
      <div class="form-join" style="font-size: 20px;"> 
         <form id="regForm" name="regForm" action="#" method="post" novalidate class="sendForm"> 
            ...
            <div class="form-join d-flex justify-content-center">
               ...
               <div class="col-sm-4">
                  <select id="userFlag" name="userFlag" class="form-select form-select mb-3" aria-label=".form-select-lg example" style="font-size: 20px;">
            ...
            <div class="form-join d-flex justify-content-center">
               ...
               <div class="col-sm-4"> 
                  <input type="text" class="form-control" name="userId" id="userId" style="font-size: 20px;" placeholder="4 ~ 20자의 영문, 숫자만 사용가능" >
            ...
            <input class="cart-btn" id="submitCheck" type="submit" value="회원가입" style="font-size: 20px;padding:1.6%;">
               &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
               <a href="/" style="background-color: #FFCC80; color: #554838; font-size: 20px" class="cart-btn"><b>취소</b></a>
            </div>
