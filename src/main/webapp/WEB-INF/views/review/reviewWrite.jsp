				...
				<div class="col-lg-8" style="margin: 0 auto;">
					<div class="single-article-section" style="margin: 0 auto;">
						...
						<div class="bbttnnw" style="text-align: right;">
						 <button type="button" id="btnUpload" value="submit">등록</button>
						...
						<p>
							...
							<form name="writeForm" id="writeForm" method="post" enctype="multipart/form-data">
							  ...
							  <div id='image_preview'>
							    <input type='file' name="reviewFile" id='btnAtt' multiple='multiple' />
							    <div id='att_zone'
							...
							<h2><input type="text" name="reviewTitle" id="reviewTitle" placeholder="제목" style="outline: none; border:0px;"/></h2>
							<hr class="hr-3">
							<img id="preview" onchange="readURL(this);" onkeydown="resize(this)" onkeyup="resize(this)"/>
						
							<textarea name="reviewContent" id="reviewContent" class="newTweetContent" onkeydown="resize(this)" onkeyup="resize(this)" ></textarea>
							</p>
						</form>
